...
def get_parser():
    ...
    parser.add_argument('-r', '--remove', help='Remove todo', action='store_true')
    parser.add_argument('-c', '--complete', help='Complete todo', action='store_true')
    parser.add_argument('-s', '--show', help='Show todo', action='store_true' )
